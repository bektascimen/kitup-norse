...
export default function RootLayout() {
  ...
  // Hide the native splash exactly when everything's hydrated, so it
  // hands off straight to the first screen with no black flash in
  // between fonts-ready and i18n-ready.
  useEffect(() => {
